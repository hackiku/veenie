...
export class RapierBridge {
	 ...
	 */
	// In bridge.ts, modify the update method:

	update(delta: number): void {
		// Log the update call
		console.log("Bridge update called, delta:", delta, "paused:", this.paused);
		...
		console.log("Entities for physics update:", entities.length);
		...
		for (const entity of entities) {
			...
			if ('properties' in entity) {
				console.log("Updating balloon physics for entity:", entity.id);
